/*
Binary clock with on Arduino
Верхний ряд светодиодов отображает первую цифру часов и минут, а нижний ряд вторую.
Складывая числа верхнего и нижнего ряда, получим значение часов и минут.
*/
